...
In mid-March, I read a coherent, convincing take-down of Generative AI. It's titled *[There is no AI revolution](https://www.wheresyoured.at/wheres-the-money/),* written by this guy Ed Zitron.
...
- the company I work for is very confident [about ai](https://nitter.net/tobi/status/1909231499448401946#m).
...
Well, it can do simple math. But it doesn't *understand* math. Apple did a study—when [a word is changed in the math problem](https://machinelearning.apple.com/research/gsm-symbolic), it fails up to 65% more often. That can’t be right! I don't get 65% worse when the "apples" turn into "oranges"!
...
Well, like I said [2 years ago](https://www.newsletter.kahvipatel.com/p/on-ai-part-3), use it as an *interface around* software.

> Instead of using programming languages or interfaces or buttons or Excel or a UI…just use English!

[This article](https://sgnt.ai/p/hell-out-of-llms/) puts it pretty well. You want the LLM on the outside as the interface. This relates quite directly to [MCPs](https://www.anthropic.com/news/model-context-protocol).
...
But, unfortunately, I don't think this is the path to AGI. From [this article](https://techcrunch.com/2024/11/20/ai-scaling-laws-are-showing-diminishing-returns-forcing-ai-labs-to-change-course/):
...
- Ashley and I hosted an Oscars watch party
	![](https://cdn.kahvipatel.com/newsletter-assets/161270654-img-002.jpg)
- tried freediving for the first (and second) time and loved it
	![](https://cdn.kahvipatel.com/newsletter-assets/161270654-img-003.jpg)
- I attended the helicopter logging safety forum
	![](https://cdn.kahvipatel.com/newsletter-assets/161270654-img-004.jpg)
